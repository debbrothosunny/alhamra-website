@extends('backend.layouts.app')
  @section('content')
    <div>
            ...
            <div class="col-lg-12 grid-margin stretch-card mx-auto">
                <div class="card">
                    ...
                    <ul class="navbar-nav d-inline mb-3">
                        ...
                        <a class="nav-link btn btn-success create-new-button px-3"  data-toggle="modal" data-target="#add" href="#"> + Add New Contact Message</a>
                        </li>
                    </ul>
                    <div class="table-responsive">
                        ...
                        @if(Session::has('success'))
                         ...
                         @endif
                            ...
                            <tbody>
                                @forelse($contact_message as $postData)
                                <tr>
                                    <td>{{$postData->name}}</td>
        ...
        <div class="modal fade" id="add" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                ...
                <div class="modal-body">
                    <form action="{!!route('save.contact_message_create')!!}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group">
                            <label for="recipient-name" class="col-form-label">Subjcet</label>
                            <textarea class="form-control"  placeholder="Type Your Subject"id="exampleTextarea1" name="subject"  rows="5" required ></textarea>
                            <span class="text-danger">@error('subject'){{$message}}@enderror</span>
                        </div>
                        <div class="form-group">
                            <label for="recipient-name" class="col-form-label">Comment</label>
                            <input type="text" name="comment" class="form-control" placeholder="Upload Image"required>
        ...
        <!-- Delete Post Modal  -->
        @foreach($contact_message as $postData)
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer justify-content-center">
                        ...
                        <a href="{{url('/contact_message/delete')}}/{{$postData->id}}" type="button"
