    ...
    <div>
        <div class="page-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Best Hotels Image</li>
            </ol>
            </nav>
        </div>
        <div class="row">
            <div class="col-lg-12 grid-margin stretch-card mx-auto">
                <div class="card">
                    ...
                    <ul class="navbar-nav d-inline mb-3">
                        ...
                        <a class="nav-link btn btn-success create-new-button px-3"  data-toggle="modal" data-target="#add" href="#"> + Add New Hotels Image</a>
                        </li>
                    </ul>
                    <div class="table-responsive">
                        ...
                        @if(Session::has('success'))
                         ...
                         @endif
                            ...
                            <tbody>
                                @forelse($best_hotels_image as $postData)
                                <tr>
        ...
        <div class="modal fade" id="add" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                ...
                <div class="modal-body">
                    <form action="{!!route('save.best_hotels_image_create')!!}" method="POST" enctype="multipart/form-data">
                        @csrf
        ...
        @foreach ($best_hotels_image as $postData)
            <div class="modal fade" id="{{ 'edit'.$postData->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    ...
                    <div class="modal-body">
                        <form action="{!!route('update.best_hotels_image', $postData->id)!!}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="form-group">
                                <label for="recipient-name" class="col-form-label">Image <span>500kb<span></label>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer justify-content-center">
                        ...
                        <a href="{{url('/best_hotels_image/delete')}}/{{$postData->id}}" type="button"
