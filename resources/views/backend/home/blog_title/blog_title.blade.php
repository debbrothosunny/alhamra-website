@extends('backend.layouts.app')
  @section('content')
    <div>
            ...
            <div class="col-lg-12 grid-margin stretch-card mx-auto">
                <div class="card">
                    ...
                    <ul class="navbar-nav d-inline mb-3">
                        ...
                        <a class="nav-link btn btn-success create-new-button px-3"  data-toggle="modal" data-target="#add" href="#"> + Add Blog Title</a>
                        </li>
                    </ul>
                    <div class="table-responsive">
                        ...
                        @if(Session::has('success'))
                         ...
                         @endif
                            ...
                            <tbody>
                                @forelse($blog_title as $postData)
                                <tr>
        ...
        <div class="modal fade" id="add" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                ...
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Add Blog Title</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <form action="{!!route('save.blog_title_create')!!}" method="POST" enctype="multipart/form-data">
                        @csrf
        ...
        <!-- Add Modal End -->
        <!-- Edit Modal -->
        @foreach ($blog_title as $postData)
            <div class="modal fade" id="{{ 'edit'.$postData->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Edit Blog Title</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body">
                        <form action="{!!route('update.blog_title', $postData->id)!!}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="form-group">
                                <label for="recipient-name" class="col-form-label">Title</label>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer justify-content-center">
                        ...
                        <a href="{{url('/blog_title/delete')}}/{{$postData->id}}" type="button"
