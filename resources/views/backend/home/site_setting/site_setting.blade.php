            ...
            <div class="col-lg-12 grid-margin stretch-card mx-auto">
                <div class="card">
                    ...
                    <ul class="navbar-nav d-inline mb-3">
                        ...
                        <a class="nav-link btn btn-success create-new-button px-3"  data-toggle="modal" data-target="#add" href="#"> + Add New Site Setting</a>
                        </li>
                    </ul>
                        ...
                        @if(Session::has('success'))
                         ...
                         @endif
                            ...
                            <tbody>
                                ...
                                <tr>
                                <td>{!!Str::limit($postData->copyright,'30', '....')!!}</td>
                                <td>{{$postData->button}}</td>
                                    <td><img style="width: 40px; border-radius: 50px;" src="{!! asset('assets/img/uploaded/'.$postData->logo) !!}" alt="none"></td>
                                    <td>
        ...
        <div class="modal fade" id="add" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                ...
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Add Site Setting</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <form action="{!!route('save.site_setting_create')!!}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group">
                            <label for="recipient-name" class="col-form-label">Copyright</label>
                            <input type="text" name="copyright" placeholder="Copyright Text" class="form-control" required>
                            <span class="text-danger">@error('copyright'){{$message}}@enderror</span>
                        </div>

                        <div class="form-group">
                            <label for="recipient-name" class="col-form-label">Button</label>
                            <input type="text" name="button" placeholder="Button Name Here"  class="form-control" required>
                            <span class="text-danger">@error('button'){{$message}}@enderror</span>
                        </div>

                        <div class="form-group">
                            <label for="recipient-name" class="col-form-label">Logo<span>500kb<span></label>
                            <input type="file" name="logo" placeholder="Upload Your Logo"  class="form-control" required>
        ...
        @foreach ($site_setting as $postData)
            <div class="modal fade" id="{{ 'edit'.$postData->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Site Setting Update</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body">
                        <form action="{!!route('update.site_setting', $postData->id)!!}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="form-group">
                                <label for="recipient-name" class="col-form-label">Copyright</label>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer justify-content-center">
                        ...
                        <a href="{{url('/site_setting/delete')}}/{{$postData->id}}" type="button"
