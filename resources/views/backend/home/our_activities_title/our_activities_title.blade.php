    ...
    <div>
        <div class="page-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">our activities title</li>
            </ol>
            </nav>
        </div>
        <div class="row">
            <div class="col-lg-8 grid-margin stretch-card mx-auto">
                <div class="card">
                    ...
                    <ul class="navbar-nav d-inline mb-3">
                        ...
                        <a class="nav-link btn btn-success create-new-button px-3"  data-toggle="modal" data-target="#add" href="#"> + Add New our activities title</a>
                        </li>
                    </ul>
                    <div class="table-responsive">
                        ...
                        @if(Session::has('success'))
                         ...
                         @endif
                            ...
                            <tbody>
                                @forelse($our_activities_title as $postData)
                                <tr>
        ...
        <div class="modal fade" id="add" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                ...
                <div class="modal-body">
                    <form action="{!!route('save.our_activities_title_create')!!}" method="POST" enctype="multipart/form-data">
                        @csrf
        ...
        @foreach ($our_activities_title as $postData)
            <div class="modal fade" id="{{ 'edit'.$postData->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Edit Our Activities Title</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body">
                        <form action="{!!route('update.our_activities_title', $postData->id)!!}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="form-group">
                                <label for="recipient-name" class="col-form-label">Title</label>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer justify-content-center">
                        ...
                        <a href="{{url('/our_activities_title/delete')}}/{{$postData->id}}" type="button"
