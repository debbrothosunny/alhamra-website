@extends('backend.layouts.app')
  @section('content')
    <div>
        ...
        <div class="modal fade" id="add" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                ...
                <div class="modal-body">
                    <form action="{!!route('save.why_choose_us_content_create')!!}" method="POST" enctype="multipart/form-data">
                        @csrf
        ...
        <!-- Add Modal End -->
        <!-- Edit Modal -->
        @foreach ($why_choose_us_content as $postData)
            <div class="modal fade" id="{{ 'edit'.$postData->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    ...
                    <div class="modal-body">
                        <form action="{!!route('update.why_choose_us_content', $postData->id)!!}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="form-group">
                                <label for="recipient-name" class="col-form-label">Title</label>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer justify-content-center">
                        ...
                        <a href="{{url('/why_choose_us_content/delete')}}/{{$postData->id}}" type="button"
