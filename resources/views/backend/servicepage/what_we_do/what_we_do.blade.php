    ...
    <div>
        <div class="page-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">What We Do Title</li>
            </ol>
            </nav>
        </div>
        <div class="row">
            <div class="col-lg-12 grid-margin stretch-card mx-auto">
                <div class="card">
                    ...
                    <ul class="navbar-nav d-inline mb-3">
                        ...
                        <a class="nav-link btn btn-success create-new-button px-3"  data-toggle="modal" data-target="#add" href="#"> + Add New Title</a>
                        </li>
                    </ul>
                    <div class="table-responsive">
                        ...
                        @if(Session::has('success'))
                         ...
                         @endif
                            ...
                            <tbody>
                                @forelse($what_we_do as $postData)
                                <tr>
                                    <td>{{$postData->title}}</td>
                                    <td>{{$postData->subtitle}}</td>
                                    <td><img style="width: 40px; border-radius: 50px;" src="{!! asset('assets/img/uploaded/'.$postData->bg_img) !!}" alt="none"></td>
                                    <td>
        ...
        <div class="modal fade" id="add" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                ...
                <div class="modal-body">
                    <form action="{!!route('save.what_we_do_create')!!}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="subtitle" placeholder="Type Sub Title" class="form-control" required>
                            <span class="text-danger">@error('subtitle'){{$message}}@enderror</span>
                        </div>
                        <div class="form-group">
                            <label for="recipient-name" class="col-form-label">Background Image<span>500kb<span></label>
                            <input type="file" name="bg_img" placeholder="Upload Background Image Upload" class="form-control" required>
                            <span class="text-danger">@error('bg_img'){{$message}}@enderror</span>
                        </div>
        ...
        @foreach ($what_we_do as $postData)
            <div class="modal fade" id="{{ 'edit'.$postData->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    ...
                    <div class="modal-body">
                        <form action="{!!route('update.what_we_do', $postData->id)!!}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="form-group">
                                <label for="recipient-name" class="col-form-label">Title</label>
                            ...
                            <div class="form-group">
                                <label for="recipient-name" class="col-form-label">Subtitle</label>
                                <input type="text" name="subtitle" value="{{ $postData->subtitle }}" class="form-control" >
                                <span class="text-danger">@error('subtitle'){{$message}}@enderror</span>
                            </div>
                            <div class="form-group">
                                <label for="recipient-name" class="col-form-label">Background Image<span>500kb<span></label>
                                <input type="file" name="bg_img" value="{{$postData->bg_img}}" class="form-control" >
                                <span class="text-danger">@error('bg_img'){{$message}}@enderror</span>
                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer justify-content-center">
                        ...
                        <a href="{{url('/what_we_do/delete')}}/{{$postData->id}}" type="button"
